...
num_classes = 2
model = torchvision.models.detection.fasterrcnn_resnet50_fpn_v2(pretrained=False, progress=True)
in_features = model.roi_heads.box_predictor.cls_score.in_features
model.roi_heads.box_predictor = FastRCNNPredictor(in_features, num_classes)
model.load_state_dict(torch.load("model/fasterrcnn_resnet50_fpn_v2/model_weights_epoch_10.pth"))
model.to(device)
model.eval()
...
image_dir = r"real"
result_dir = r"real/fasterrcnn_resnet50_fpn_v2"
